...
var obj={
	query:function(){
		$(grid_selector).jqGrid({
			...
			colModel:[
				{name:'schemeName',index:'schemeName',width:80,sortable:false},
				{name:'addTime',index:'addTime', width:150,sortable:false,formatter:formatDate},
				{name:'modifyTime',index:'addTime', width:150,sortable:false,formatter:formatDate},
