...
<html>
<head>
<title>${fns:getConfig('productName')}-培训订单列表</title>
...
<body>
	<ul id="breadcrumb" style="display: none">
		...
		<li class="active">培训订单列表</li>
	</ul>
	<ul class="nav nav-tabs padding-12">
		<li class="active"><a href="#">培训订单列表</a></li>
	...
	<div class="searchbar"> 
        <form class="form-horizontal" action="" id="queryForm" method="GET">
            <div class="form-group">
	            ...
	            <div class="col-md-2">
	            	<input type="text" class="form-control" id="userName" name="wechatNick" value="" />
	            </div>
    ...
    <div class="page-content">
    	<div class="page-heading mb5">
        	<div class="text-left small">
	        	...
	        	<span class="col-md-2" style="float: right;paddind-top: 3px">EXCEL下载：<a style="cursor: pointer;" id="exportBtn">EXCEL下载</a></span>
	    	</div>
	    </div>
		<div class="page-body">
	...
	<script src="${ctxStatic}/modules/applyOrder/list.js"></script>
