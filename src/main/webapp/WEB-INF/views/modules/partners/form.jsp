				...
				<c:if test="${update == 'false'}">
					...
					<div class="form-group form-color">
						<div class="form-group form-padding">
							<label class="col-sm-2 control-label">合作商类型<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4">
							...
							<label class="col-sm-2 control-label">合作商名称<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4">
								<input type="text" id="partnerName" maxlength="50" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">合作商地址<span class="dr-asterisk">*</span></label>
							<div class="col-sm-2">
							...
							<div class="col-sm-4">
								<input type="text" id="address" maxlength="50" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">邮编<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4" >
								<input type="text" id="zipCode" maxlength="50" class="form-control" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label">门店号码<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4" >
								<input type="text" id="storePhone" maxlength="50" class="form-control" />
							</div>
						</div>
					</div>
					<div class="form-group" style="margin-bottom: 5px;">
				...
				<c:if test="${update == 'true'}">
					...
					<div class="form-group form-color">
						...
						<div class="form-group form-padding">
							<label class="col-sm-2 control-label">合作商类型<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4">
								<select class="chosen-select form-control" id="partnerType" disabled="disabled">
									<option value="">--请选择--</option>
									<c:forEach items="${fns:getParams(5,28)}" var="obj" varStatus="item">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" id="address" maxlength="200" class="form-control" value="${model.address}"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">邮编<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4" >
								<input type="text" id="zipCode" maxlength="50" class="form-control"  value="${model.zipCode}"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">联系人<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4" >
								<input type="text" id="contacts" maxlength="50" class="form-control" value="${model.contacts}" />
							</div>
							<label class="col-sm-2 control-label">手机号码<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4" >
								<input type="text" id="contactPhone" maxlength="50" class="form-control" value="${model.contactPhone}"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">门店号码<span class="dr-asterisk">*</span></label>
							<div class="col-sm-4" >
								<input type="text" id="storePhone" maxlength="50" class="form-control" value="${model.storePhone}"/>
							</div>
						</div>
					</div>
					<div class="form-group" style="margin-bottom: 5px;">
