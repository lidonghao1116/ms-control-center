...
<html>
	<head>
		...
		<style type="text/css">
			...
			div.main_m ul{list-style:none;} 
			div.main_m li{float:left;height: 40px;width:100px;background: #1F9DE5;text-align: center;padding-top: 10px;margin-left:10px} 
			div.main_m li a{color: white;}
			div.main_m li.active{background: rgb(15, 124, 209);}
					...
					<ul class="nav ace-nav">
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${ctxStatic}/css/images/user.jpg" alt="用户头像" />
								<span class="user-info">
									<small>欢迎,</small> ${fns:getUser().loginName}
								</span>
