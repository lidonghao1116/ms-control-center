...
public class SchoolsOpt {
	...
	public static Map<Object, Object> buildMap(SchoolsEntity shoolsEntity){
		...
		if (!StringUtils.isEmpty(shoolsEntity.getPrivince())) {
			map.put("privince", shoolsEntity.getPrivince());
		}
		if (!StringUtils.isEmpty(shoolsEntity.getCity())) {
			map.put("city", shoolsEntity.getCity());
		}
		if (!StringUtils.isEmpty(shoolsEntity.getArea())) {
			map.put("area", shoolsEntity.getArea());
		}
