...
public class UsersOpt {
	...
	public static Map<Object, Object> buildMap(UsersQuery usersQuery){
		...
		if(!StringUtils.isEmpty(usersQuery.getMobile())){
			map.put("mobile", usersQuery.getMobile());
		}
		if(!StringUtils.isEmpty(usersQuery.getInviteCode())){
			map.put("inviteCode", usersQuery.getInviteCode());
		}
		...
		if(!StringUtils.isEmpty(usersQuery.getAuthStatus())){
			map.put("authStatus", usersQuery.getAuthStatus());
		}
